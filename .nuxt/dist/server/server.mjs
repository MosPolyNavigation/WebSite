import { reactive, getCurrentInstance, version, unref, isRef, inject, ref, watchEffect, watch, toRef, nextTick, shallowRef, computed, isReadonly, h, defineComponent, Suspense, Transition, provide, useSSRContext, onErrorCaptured, onServerPrefetch, defineAsyncComponent, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/about-902c4217.js").then((m) => m.default || m)
  },
  {
    name: "accord",
    path: "/accord",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/accord-efba392c.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-cf941f08.js").then((m) => m.default || m)
  },
  {
    name: "map",
    path: "/map",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/map-c855ca9b.js").then((m) => m.default || m)
  },
  {
    name: "mobile",
    path: "/mobile",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/mobile-851f1955.js").then((m) => m.default || m)
  },
  {
    name: "scalePage",
    path: "/scalePage",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/scalePage-8a2dfd19.js").then((m) => m.default || m)
  },
  {
    name: "start",
    path: "/start",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/start-f4342044.js").then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-component-cee850f9.js").then((r) => r.default || r));
